    ...
    layui.use(['form', 'laydate', 'upload', 'laypage'], function () {
        ...
        laydate.render({
            ...
            range: true,
                ...
                if (time) {
                    $.ajax({
                        type: "GET",
                        url: "http://8.131.247.153/video/search_time_video/",
                        dataType: "json",
                        headers: {
        ...
        $('#ts-move-video').on('click', function () {
            if (checkTsLibrary.length <= 0) {
                ...
                $.post({
                    url: "http://8.131.247.153/video/save_media_library/",
                    dataType: "json",
                    headers: {
                        token: sessionStorage.getItem('token')
                    },
        ...
        $('#delete-video').on('click', function () {
            ...
            layer.open({
                ...
                btn1: function () {
                    $.ajax({
                        type: 'GET',
                        url: 'http://8.131.247.153/video/delete_video/',
                        dataType: "json",
                        headers: {
                            token: sessionStorage.getItem('token')
                        },
        ...
        $('#uploadVideo').on('click', function () {
            layer.open({
                ...
                btn1: function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'http://8.131.247.153/video_editing/upload_video/',
                        headers: {
                            token: sessionStorage.getItem('token')
                        },
                        data: formData,
        ...
        function monitorState(id) {
            ...
            timer = setInterval(() => {
                $.ajax({
                    type: "GET",
                    dataType: "json",
                    url: "http://8.131.247.153/video_editing/upload_video_status/",
                    data: {
                        upload_action_id: id
                    },
                    headers: {
        ...
        $('.videoContent').on('click', '.video-edit', function () {
            ...
            layer.open({
                ...
                btn1: function () {
                    ...
                    $.ajax({
                        type: 'POST',
                        url: 'http://8.131.247.153/video/update_video_description/',
                        headers: {
                            token: sessionStorage.getItem('token')
                        },
                        dataType: "json",
        ...
        function getComment(id) {
            $.ajax({
                ...
                dataType: "json",
                async: false,
                url: "http://8.131.247.153/commenting/h5_comments_show/",
                data: {
                    video_id: id
                },
                headers: {
        ...
        $('.commentBox').on('click', '.deleteChat', function () {
            ...
            $.ajax({
                ...
                dataType: "json",
                async: false,
                url: "http://8.131.247.153/commenting/delete_comments/",
                data: {
        ...
        $('.videoContent').on('click', '.video-upload', function () {
            ...
            $.ajax({
                ...
                url: "http://8.131.247.153/video_editing/download_video/",
                data: {
                    video_code: $(this).attr('data-code')
                },
                success: function (res) {
        ...
        function downloadVideo(id) {
            ...
            downTimer = setInterval(() => {
                $.ajax({
                    ...
                    url: "http://8.131.247.153/video_editing/download_video_status/",
                    data: {
