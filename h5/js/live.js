   ...
   var shaStr = ''
    ...
    $.ajax({
        ...
        success:function(res){
            ...
            shaStr = sha1('jsapi_ticket='+res.data+'&noncestr='+srcShare+'&timestamp='+timeShare+'&url=http://www.cube.vip/h5/wxlogin.html?key='+ event_uri_key)
            wx.config({
                ...
                wx.ready(function() {
                    ...
                    wx.updateTimelineShareData({
                        title: userName, // 分享标题
                        link: 'http://www.cube.vip/h5/wxlogin.html?key='+ event_uri_key, // 分享链接，该链接域名或路径必须与当前页面对应的公众号JS安全域名一致
                        imgUrl: userImg, // 分享图标
                    });
